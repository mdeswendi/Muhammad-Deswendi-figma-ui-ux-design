# FRI Finance - UI/UX Design

## 📱 Financial Monitoring System Dashboard

**FRI Finance** adalah sistem monitoring keuangan terintegrasi untuk Fakultas Rekayasa Industri, Universitas Telkom.

### 🎯 Fitur Utama
1. **Dashboard Overview** - Ringkasan keuangan real-time
2. **Pengajuan Dana** - Proposal & reimburse digital
3. **Verifikasi** - Workflow persetujuan terstruktur
4. **Pelaporan** - Laporan keuangan otomatis
5. **Notifikasi** - Update real-time status pengajuan
